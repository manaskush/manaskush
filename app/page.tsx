...
const skills = [
  ...
  },
  {
    ...
    description:
      "Git, npm, Yarn, VSCode, Postman, Figma, Linux, macOS, Windows",
  },
];
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Manas Kush is a versatile Full-Stack Developer specializing in web applications using Next.js and React.",
    ...
    <DialogContent>
      <p className="text-muted-foreground text-lg md:pr-8">
        A passionate innovator and problem-solver who thrives on turning ideas into impactful solutions. With creativity, determination, and a drive to excel, I aim to make a difference in every project I take on. Let&apos;s create something amazing together! 🌟
              ...
              <DialogContent>
                <div className="hidden md:flex md:gap-x-10 items-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg md:pr-8">
                      A passionate innovator and problem-solver who thrives on
                      turning ideas into impactful solutions. With creativity,
                      determination, and a drive to excel, I aim to make a
                      difference in every project I take on. Let&apos;s create
            ...
            <Element
              name="resume"
              className="mt-10 resume  bg-white center-on-phone"
            >
              <ShinyButton>
          ...
          >
            ...
            <Element name="iphone">
              <a href="https://t.me/SATOSHI_FARMS_BOT/Satoshi_Farms?startapp=5474783563">
                <Iphone15ProDemo />
              </a>
            </Element>

            <Element name="skillheader">
              <h1 className="text-xl pt-10 font-semibold justify-center ">
                Skill Globe
              </h1>
            </Element>
            ...
            <h2 className="text-3xl pt-10 font-bold text-gray-800 mb-6">
              Skills
            </h2>
